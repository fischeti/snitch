...
(
  ...
  xbar_rule_48_t [1:0] WideXbarQuadrantS1Addrmap;
  ...
  wide_xbar_quadrant_s1_out_req_t  [2:0] wide_xbar_quadrant_s1_out_req;
  wide_xbar_quadrant_s1_out_resp_t [2:0] wide_xbar_quadrant_s1_out_rsp;
