...
impl std::fmt::Display for OpcodeRdRs1Rs2 {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            ...
            Self::VfsumexpB => write!(f, "vfsumexp.b"),
...
pub fn parse_u32(raw: u32) -> Format {
    ...
    match raw & 0xfe00707f {
        ...
        0xb8000033 => return parse_rd_rs1_rs2(OpcodeRdRs1Rs2::VfsumS, raw),
        0xba000033 => return parse_rd_rs1_rs2(OpcodeRdRs1Rs2::VfsumexpSH, raw),
        ...
        0xb8002033 => return parse_rd_rs1_rs2(OpcodeRdRs1Rs2::VfsumH, raw),
        0xba002033 => return parse_rd_rs1_rs2(OpcodeRdRs1Rs2::VfsumexpHB, raw),
        ...
        0xb8003033 => return parse_rd_rs1_rs2(OpcodeRdRs1Rs2::VfsumB, raw),
        0xba003033 => return parse_rd_rs1_rs2(OpcodeRdRs1Rs2::VfsumexpB, raw),
