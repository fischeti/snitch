...
declare i16 @banshee_fp16_op(i16 %rs1, i16 %rs2, i16 %rs3, i8 %op, i1 %alt)
declare i32 @banshee_fp16_op_cvt_from_f(i64 %rs1, i8 %op, i1 %alt)
declare i16 @banshee_fp16_op_cvt_to_f(i64 %rs1, i8 %op, i1 %alt)
declare i1 @banshee_fp16_op_cmp(i16 %rs1, i16 %rs2, i8 %op, i1 %alt)
declare i8 @banshee_fp8_op(i8 %rs1, i8 %rs2, i8 %rs3, i8 %op, i1 %alt)
declare i32 @banshee_fp8_op_cvt_from_f(i64 %rs1, i8 %op, i1 %alt)
declare i8 @banshee_fp8_op_cvt_to_f(i64 %rs1, i8 %op, i1 %alt)
declare i1 @banshee_fp8_op_cmp(i8 %rs1, i8 %rs2, i8 %op, i1 %alt)
